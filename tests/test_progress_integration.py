...
class ProgressIntegrationTests(unittest.TestCase):
    def test_trade_search_publishes_exact_units_and_terminal_timing(self):
    ...
    def test_weekly_collection_publishes_indeterminate_phases_and_terminal_timing(self):
