...
_INDEPENDENT_FANTASYPROS_BENCHMARK_POLICY = (
    "Not applicable: this independent bundle neither retains nor uses a "
...
_INDEPENDENT_HOST_SETTLEMENT_POLICY_LIMITATION = (
    "The host snapshot does not retain an authoritative, proof-bound contract for "
    "every multi-team tiebreak settlement case. The local tiebreak sequence and "
    "balanced head-to-head policy are a declared reconstruction."
)
...
_INDEPENDENT_SCHEDULE_PROVENANCE_LIMITATION = (
    "The independent bundle retains the player-week NFL team and game bindings used "
    "by the calculation, but not a separately auditable NFL schedule artifact or "
    "kickoff timestamps."
)
