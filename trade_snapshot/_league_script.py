"""Finite Trade Analyzer bootstrap and passive-init capture script."""


LEAGUE_SOURCE_SCRIPT = r"""
async (options) => {
  ...
  const tap = window.__tradeSnapshotAnalyzerV2;
